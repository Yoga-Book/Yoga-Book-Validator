...
SELECTOR_ACTIONS = (
    ...
    ("input/*-button-event", "Run Test buttons and lid, then press Power and both Volume buttons once."),
    ("input/volume-*-event", "Run Test buttons and lid, then press Power and both Volume buttons once."),
    ("input/lid-*-event", "Run Test buttons and lid, then close and reopen the lid or keyboard cover."),
    ("input/controls-release", "Run Test buttons and lid and allow its cleanup verification to finish."),
